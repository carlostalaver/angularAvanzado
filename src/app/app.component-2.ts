...
export class AppComponent implements AfterContentInit, AfterViewInit {
  ...
  showAddTimer() {
    ...
    /* lo meto en un setTimeout para que angular se pueda dar cuenta de que this.timeInput.nativeElement cambió, 
       ojo notar que la estrategia de deteccion de cambios es default y aún así no se dacuenta del cambio;
       esto corre porque al tocar directamente el DOM, angular no se enterará que algo cambió y ChangeDetectorRef
       no funciona para detectar cambios en el DOM, solo queda usar el setTimeout 
    */
    setTimeout(() => {
